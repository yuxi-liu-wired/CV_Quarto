...
\begin{large}
  ...
  \vspace{-0.16cm}
\end{large}
* Awarded by MSI to a student in the mathematical sciences entering the final honours year in a bachelor degree in the Mathematics honours program.
...
\end{large}
\vspace{-0.16cm}
**Languages and Tools** - *proficient:* Python, PyTorch; *competent:* Git, Bash, LaTeX, HTML, JavaScript.
